...
const Zigzag = ({ zigzagImg, isPr, isReverse, isPt136, title, paragraph, paragraph1, isParagraph1, paragraph2, isParagraph2, paragraph3, isParagraph3, buttonText, isButton, isPb }) => {
    return (
        <>
            <section className={`lg:flex pt-20 sm:pt-150 ${isPb ? 'pb-0' : 'pb-20 sm:pb-150'}`}>
